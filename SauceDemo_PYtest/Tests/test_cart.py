...
class TestCartPage:
    def test_validate_cart_page(self,init_driver):
    ...
    def test_remove_item_from_cart(self,init_driver):
        login_page = LoginPage(init_driver)
        login_page.login()
    ...
    def test_continue_shopping_button(self,init_driver):
        login_page = LoginPage(init_driver)
        login_page.login()
    ...
    def test_checkout_button(self,init_driver):
        login_page = LoginPage(init_driver)
        login_page.login()
